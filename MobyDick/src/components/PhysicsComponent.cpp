...
void PhysicsComponent::update()
{
	...
	parent()->transformComponent.value()->setPosition(convertedPosition, convertedAngle);
}
...
void PhysicsComponent::attachItem(GameObject* attachObject, std::optional<b2Vec2> attachLocation)
{
	...
	const auto& attachObjectPhysicsComponent = attachObject->physicsComponent.value();
